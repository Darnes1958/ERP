...
class MyBuy extends Page implements HasForms,HasTable,HasActions
{
    ...
    protected static string $view = 'filament.pages.my-buy';
                ...
                Section::make()
                    ->schema([
                        \Filament\Forms\Components\Actions::make([
                            ...
                            \Filament\Forms\Components\Actions\Action::make('storewithbank')
                                ->label('تخزين')
                                ->icon('heroicon-m-plus')
                                ->button()
                                ->visible(function (){return Buy_tran_work::where('buy_id',$this->buy_id)->count()>0
