...
class TarBuy extends Page implements HasTable,HasForms
{
    protected static string $resource = BuyResource::class;

    protected string $view = 'filament.market.resources.buy-resource.pages.tar-buy';
  ...
  public function for(Schema $schema): Schema
  {
      return $schema
          ->model(Tar_buy::class)
