...
class BuyEdit extends Page implements HasTable,HasForms
{
    ...
    protected string $view = 'filament.market.resources.buy-resource.pages.buy-edit';
    ...
    public function buyTranForm(Schema $schema): Schema
{
        ...
        Section::make()
            ->schema([
                ...
                TextInput::make('price_input')
                    ...
                    ->required()
                    ->id('price_input')
                    ->extraInputAttributes(['wire:keydown.enter' => 'ChkPrice($event.target.value)',]),
    ...
    public function ChkPrice($price_input){
        if ($price_input!=null && $price_input>0)
            $this->dispatch('gotoitem', test: 'q1');
    }
