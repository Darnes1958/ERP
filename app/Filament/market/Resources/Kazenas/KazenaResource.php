...
namespace App\Filament\market\Resources\Kazenas;

use App\Filament\market\Resources\Kazenas\Pages\CreateKazena;
use App\Filament\market\Resources\Kazenas\Pages\EditKazena;
use App\Filament\market\Resources\Kazenas\Pages\ListKazenas;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('user_name')
                    ->state(function (Kazena $record)
                    {if ($record->user_id!=null && User::find($record->user_id)) {return User::find($record->user_id)->name;} else return null;} )
                    ->label('المستخدم'),
