...
class EditBuy extends Page implements HasTable
{
    ...
    protected string $view = 'filament.market.resources.buys-work-resource.pages.edit-buy';
                        ...
                        ->afterStateUpdated(function ($state){
                            ...
                            if(Buy_tran::where('buy_id',$state)
                                ...
                                Notification::make()
                                    ...
                                    ->icon('heroicon-o-check')->iconColor('success')->send();
                                $this->buy_id='';
                                $this->buyForm->fill([]);
                                $this->buyTranForm->fill([]);
                            }
    ...
    public function ChkBarcode(){
        ...
        if (! $res)
            ...
            $this->fill_item(Item::find($res->item_id,$this->buytranData['barcode_id']));
    ...
    public function ChkItem(){
        ...
        if (!$item) return;
        $this->fill_item($item,$item->barcode_id);
